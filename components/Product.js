    ...
    return (
      <Block row={horizontal} card flex style={[styles.product, styles.shadow, style]}>
        ...
        <Block row={!horizontal} space="between" style={{ padding: theme.SIZES.BASE, }}>
          ...
          <Block middle>
            <Icon name="map-marker" family="font-awesome" color={theme.COLORS.MUTED} size={24} onPress={() => product.map==undefined?'':navigation.navigate('TourismMap',{map:product.map}) }/>
